...
public partial class Index : System.Web.UI.Page
{
    ...
    //protected void PackageDisplay(object sender, ImageClickEventArgs e)
    //{
    //    ImageButton myButton = (ImageButton)sender;
    //    string passingValue = myButton.ID.ToString();
    //    Response.Redirect(String.Format("PackageDisplay.aspx?myButton=" + passingValue.ToString(), Server.UrlEncode(passingValue.ToString())));
